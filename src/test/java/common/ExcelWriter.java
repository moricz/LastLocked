...
public class ExcelWriter {
	...
	public static void writeListToExcel(String FILE_PATH, List<HashMap<String, String>> studentList) {
		...
		for (HashMap<String, String> student : studentList) {
			...
			row.createCell(cellIndex++).setCellValue(Double.parseDouble(student.get("addfail")));
		}
